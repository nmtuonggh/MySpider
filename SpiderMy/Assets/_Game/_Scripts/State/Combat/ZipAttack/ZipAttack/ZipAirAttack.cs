...
namespace SFRemastered.Combat.ZipAttack
{
    ...
    public class ZipAirAttack : ZipAttack
    {
        public override void EnterState()
        {
            ...
            DrawnWeb(_blackBoard._zipAttackHandPositon.transform.position, (_blackBoard._targetEnemy.transform.position + targetPos * 1f) + new Vector3(0, 0.1f, 0));

            _blackBoard.playerMovement.transform.DOMove((_blackBoard._targetEnemy.transform.position + targetPos * 1f) + new Vector3(0, 0.05f, 0), 0.35f)
